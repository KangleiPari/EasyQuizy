    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        java.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                java.setBackgroundResource(R.drawable.round_black_white_stroke10);
        ...
        php.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                php.setBackgroundResource(R.drawable.round_black_white_stroke10);
        ...
        html.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                html.setBackgroundResource(R.drawable.round_black_white_stroke10);
        ...
        android.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                android.setBackgroundResource(R.drawable.round_black_white_stroke10);
